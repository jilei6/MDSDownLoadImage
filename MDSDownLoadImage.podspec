#
#  Be sure to run `pod spec lint MDSDownLoadImage.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "jilei"
  # s.authors            = { "jilei" => "434450279@qq.com" }
  # s.social_media_url   = "http://twitter.com/jilei"
  ...
  s.source       = { :git => "https://github.com/jilei6/MDSDownLoadImage.git", :tag => "#{s.version}" }
